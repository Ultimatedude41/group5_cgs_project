...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2025 at 03:35 AM
...
-- Database: `foodmenu`
--
CREATE DATABASE IF NOT EXISTS `foodmenu` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `foodmenu`;
...
('root', '[{\"db\":\"foodmenu\",\"table\":\"food\\/price\"}]');
...
('root', '2025-11-29 02:33:23', '{\"Console\\/Mode\":\"collapse\"}');
